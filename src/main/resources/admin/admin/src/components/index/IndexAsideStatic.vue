<template>
	<div class="menu-preview">
		...
		<el-scrollbar wrap-class="scrollbar-wrapper">
			<el-menu :default-openeds="[]" :unique-opened="true" :style='{"border":0,"padding":"0 0 60px","listStyle":"none","margin":"0","flexWrap":"wrap","background":"none","flexDirection":"column","display":"flex","width":"100%","position":"relative"}' class="el-menu-vertical-demo" default-active="0">
	...
	methods: {
		...
		styleChange() {
			this.$nextTick(() => {
				  ...
				  const icon = {"border":"none","margin":"8px auto 0 auto","background":"none","display":"none"}
	...
	.menu-preview {
	  .el-scrollbar {
		...
		.el-menu-vertical-demo>.el-menu-item {
				  				  ...
				  				  color: #987ade;
				  				  white-space: nowrap;
				  				  background: url(http://codegen.caihongy.cn/20221130/746767f49f894600bbbfb2c379611ea2.png) no-repeat;
				  				  width: 100%;
				  				  line-height: 66px;
				  				  position: relative;
				  				  text-align: center;
