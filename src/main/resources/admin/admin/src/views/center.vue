  ...
  <div :style='{"padding":"10px 30px"}'>
    ...
    >  
     <el-row>
        ...
        <el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}'   v-if="flag=='yonghu'"  label="手机号" prop="shoujihao">
