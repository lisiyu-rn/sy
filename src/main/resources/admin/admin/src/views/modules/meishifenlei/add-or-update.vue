<template>
	<div class="addEdit-block" :style='{"padding":"10px 30px"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="美食分类" prop="meishifenlei">
					<el-input v-model="ruleForm.meishifenlei" placeholder="美食分类" clearable  :readonly="ro.meishifenlei"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' v-else class="input" label="美食分类" prop="meishifenlei">
					<el-input v-model="ruleForm.meishifenlei" placeholder="美食分类" readonly></el-input>
				</el-form-item>
			</template>
