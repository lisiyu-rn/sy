...
<div class="recommend" :style='{"padding":"60px 7% 20px","margin":"30px auto 10px","textAlign":"center","background":"url(http://codegen.caihongy.cn/20230112/29169018b843423c8957ea726e68c749.png) no-repeat center top","width":"100%","backgroundSize":"100%","position":"relative","order":"5"}'>
    ...
    <div class="title" :style='{"width":"100%","margin":"0px auto 0px","lineHeight":"54px","textAlign":"center","background":"none","height":"50px"}'>
		<span :style='{"color":"#333","margin":"0 8px 0 20px","fontSize":"32px"}'>美食信息推荐</span>
	</div>
	...
	<div class="list list2 index-pv1" :style='{"padding":"0px 0","margin":"140px 0 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
		<div :style='{"margin":"0 0 40px","flexWrap":"wrap","background":"none","display":"flex","width":"48%","fontSize":"0","position":"relative","justifyContent":"space-between","height":"auto"}' v-for="(item,index) in meishixinxiRecommend" class="list-item animation-box" :key="index" @click="toDetail('meishixinxiDetail', item)">
			<img :style='{"border":"2px dashed #333","padding":"10px","objectFit":"cover","borderRadius":"100%","display":"inline-block","width":"285px","height":"285px"}' v-if="preHttp(item.fengmian)" :src="item.fengmian.split(',')[0]" alt="" />
			<img :style='{"border":"2px dashed #333","padding":"10px","objectFit":"cover","borderRadius":"100%","display":"inline-block","width":"285px","height":"285px"}' v-else :src="baseUrl + (item.fengmian?item.fengmian.split(',')[0]:'')" alt="" />
			<div class="item-info" :style='{"width":"calc(100% - 285px)","padding":"10px 0px","overflow":"hidden","display":"inline-block","height":"100%"}'>
				<div class="name line1" :style='{"padding":"0 40px 0 0","margin":"0 0 10px","whiteSpace":"nowrap","color":"#333","textAlign":"right","overflow":"hidden","background":"url(http://codegen.caihongy.cn/20230112/71572c80be344dfc9b3c7ebecf07a4c5.png) no-repeat center top / 100% 100%","width":"100%","lineHeight":"50px","fontSize":"18px","backgroundSize":"100% 100%","textOverflow":"ellipsis","height":"68px"}'>{{item.caipinmingcheng}}</div>
				<div class="name line1" :style='{"padding":"0 40px 0 0","margin":"0 0 10px","whiteSpace":"nowrap","color":"#333","textAlign":"right","overflow":"hidden","background":"url(http://codegen.caihongy.cn/20230112/71572c80be344dfc9b3c7ebecf07a4c5.png) no-repeat center top / 100% 100%","width":"100%","lineHeight":"50px","fontSize":"18px","backgroundSize":"100% 100%","textOverflow":"ellipsis","height":"68px"}'>美食分类:{{item.meishifenlei}}</div>
			</div>
		</div>
	</div>
	...
	<div @click="moreBtn('meishixinxi')" :style='{"border":"2px solid #fff","margin":"60px auto 0px","top":"0","borderRadius":"30px","textAlign":"center","background":"none","display":"block","width":"110px","lineHeight":"40px","position":"absolute","right":"7%"}'>
...
<div class="news" :style='{"width":"45%","margin":"10px 7% 10px","position":"relative","background":"none","flex":"1","order":"2"}'>
	...
	<div class="title" :style='{"width":"100%","padding":"0px 20px 10px","margin":"60px auto 20px","lineHeight":"80px","textAlign":"center","background":"url(http://codegen.caihongy.cn/20230112/29169018b843423c8957ea726e68c749.png) no-repeat center bottom / 100% auto"}'>
		<span :style='{"color":"#333","margin":"0 8px 0 0","fontSize":"18px"}'>美食资讯</span>
	</div>
...
<div class="lists" :style='{"padding":"20px 7% 0","margin":"20px auto 0px","background":"url(http://codegen.caihongy.cn/20230112/386f2f8213f945c8b81e21886c653274.png) no-repeat center bottom","width":"100%","backgroundSize":" 100%","position":"relative","order":"1"}'>
	...
	<div class="title" :style='{"minHeight":"50px","width":"100%","margin":"0px auto 20px","lineHeight":"54px","textAlign":"center","background":"none"}'>
	  <span :style='{"color":"#333","margin":"0 8px 0 20px","fontSize":"32px"}'>美食信息展示</span>
	</div>
	...
	<div class="list list9 index-pv1" :style='{"padding":"0 0 240px","flexWrap":"wrap","background":"none","display":"flex","width":"100%","minWidth":"1200px","justifyContent":"space-between","height":"auto"}'>
		<div class="list-4-body" :style='{"width":"49%","margin":"0 0 20px","flexWrap":"wrap","justifyContent":"space-between","display":"flex","height":"auto"}'>
			<div v-if="meishixinxiList.length>0" @click="toDetail('meishixinxiDetail', meishixinxiList[0])" class="list-4-item animation-box item-1" :style='{"width":"48%","margin":"0 0px","position":"relative","display":"inline-block","height":"auto"}'>
				<img :style='{"border":"2px dashed #333","padding":"10px","margin":"0 0 10px","objectFit":"cover","borderRadius":"100%","width":"285px","float":"left","height":"285px"}' v-if="preHttp(meishixinxiList[0].fengmian)" :src="meishixinxiList[0].fengmian.split(',')[0]" alt="" />
				<img :style='{"border":"2px dashed #333","padding":"10px","margin":"0 0 10px","objectFit":"cover","borderRadius":"100%","width":"285px","float":"left","height":"285px"}' v-else :src="baseUrl + (meishixinxiList[0].fengmian?meishixinxiList[0].fengmian.split(',')[0]:'')" alt="" />
				<div class="list-4-item-title line1" :style='{"padding":"0 40px 0 0","margin":"0 0 10px","whiteSpace":"nowrap","overflow":"hidden","color":"#333","textAlign":"right","background":"url(http://codegen.caihongy.cn/20230112/71572c80be344dfc9b3c7ebecf07a4c5.png) no-repeat center top / 100% 100%","width":"90%","lineHeight":"50px","fontSize":"18px","textOverflow":"ellipsis","height":"68px"}'>
                    <div>{{meishixinxiList[0].caipinmingcheng}}</div>
                    <div>美食分类:{{meishixinxiList[0].meishifenlei}}</div>
                </div>
			</div>
			<div v-if="meishixinxiList.length>1" @click="toDetail('meishixinxiDetail', meishixinxiList[1])" class="list-4-item animation-box item-2" :style='{"width":"48%","margin":"60px 0px 0","position":"relative","display":"inline-block","height":"auto"}'>
				<img :style='{"border":"2px dashed #333","padding":"10px","margin":"0 0 10px","objectFit":"cover","borderRadius":"100%","width":"285px","float":"left","height":"285px"}' v-if="preHttp(meishixinxiList[1].fengmian)" :src="meishixinxiList[1].fengmian.split(',')[0]" alt="" />
				<img :style='{"border":"2px dashed #333","padding":"10px","margin":"0 0 10px","objectFit":"cover","borderRadius":"100%","width":"285px","float":"left","height":"285px"}' v-else :src="baseUrl + (meishixinxiList[1].fengmian?meishixinxiList[1].fengmian.split(',')[0]:'')" alt="" />
				<div class="list-4-item-title line1" :style='{"padding":"0 40px 0 0","margin":"0 0 10px","whiteSpace":"nowrap","overflow":"hidden","color":"#333","textAlign":"right","background":"url(http://codegen.caihongy.cn/20230112/71572c80be344dfc9b3c7ebecf07a4c5.png) no-repeat center top / 100% 100%","width":"90%","lineHeight":"50px","fontSize":"18px","textOverflow":"ellipsis","height":"68px"}'>
                    <div>{{meishixinxiList[1].caipinmingcheng}}</div>
                    <div>美食分类:{{meishixinxiList[1].meishifenlei}}</div>
                </div>
			</div>
		</div>
		<div class="list-4-body" :style='{"width":"49%","flexWrap":"wrap","justifyContent":"space-between","display":"flex","height":"auto"}'>
			<div v-if="meishixinxiList.length>2" @click="toDetail('meishixinxiDetail', meishixinxiList[2])" class="list-4-item animation-box item-3" :style='{"width":"48%","margin":"0 0px","position":"relative","height":"auto"}'>
				<img :style='{"border":"2px dashed #333","padding":"10px ","margin":"0 0 10px","objectFit":"cover","borderRadius":"100%","width":"285px","float":"left","height":"285px"}' v-if="preHttp(meishixinxiList[2].fengmian)" :src="meishixinxiList[2].fengmian.split(',')[0]" alt="" />
				<img :style='{"border":"2px dashed #333","padding":"10px ","margin":"0 0 10px","objectFit":"cover","borderRadius":"100%","width":"285px","float":"left","height":"285px"}' v-else :src="baseUrl + (meishixinxiList[2].fengmian?meishixinxiList[2].fengmian.split(',')[0]:'')" alt="" />
				<div class="list-4-item-title line1" :style='{"padding":"0 40px 0 0","margin":"0 0 10px","whiteSpace":"nowrap","overflow":"hidden","color":"#333","textAlign":"right","background":"url(http://codegen.caihongy.cn/20230112/71572c80be344dfc9b3c7ebecf07a4c5.png) no-repeat center top / 100% 100%","width":"90%","lineHeight":"50px","fontSize":"18px","textOverflow":"ellipsis","height":"68px"}'>
                    <div>{{meishixinxiList[2].caipinmingcheng}}</div>
                    <div>美食分类:{{meishixinxiList[2].meishifenlei}}</div>
                </div>
			</div>
			<div v-if="meishixinxiList.length>3" @click="toDetail('meishixinxiDetail', meishixinxiList[3])" class="list-4-item animation-box item-4" :style='{"width":"48%","margin":"40px 0px 0","position":"relative","height":"auto"}'>
				<img :style='{"border":"2px dashed #333","padding":"10px","margin":"0 0 10px","objectFit":"cover","borderRadius":"100%","width":"285px","float":"left","height":"285px"}' v-if="preHttp(meishixinxiList[3].fengmian)" :src="meishixinxiList[3].fengmian.split(',')[0]" alt="" />
				<img :style='{"border":"2px dashed #333","padding":"10px","margin":"0 0 10px","objectFit":"cover","borderRadius":"100%","width":"285px","float":"left","height":"285px"}' v-else :src="baseUrl + (meishixinxiList[3].fengmian?meishixinxiList[3].fengmian.split(',')[0]:'')" alt="" />
				<div class="list-4-item-title line1" :style='{"padding":"0 40px 0 0","margin":"0 0 10px","whiteSpace":"nowrap","overflow":"hidden","color":"#333","textAlign":"right","background":"url(http://codegen.caihongy.cn/20230112/71572c80be344dfc9b3c7ebecf07a4c5.png) no-repeat center top / 100% 100%","width":"90%","lineHeight":"50px","fontSize":"18px","textOverflow":"ellipsis","height":"68px"}'>
                    <div>{{meishixinxiList[3].caipinmingcheng}}</div>
                    <div>美食分类:{{meishixinxiList[3].meishifenlei}}</div>
                </div>
			</div>
			<div v-if="meishixinxiList.length>4" @click="toDetail('meishixinxiDetail', meishixinxiList[4])" class="list-4-item animation-box item-5" :style='{"width":"390px","margin":"0 10px","position":"relative","display":"none","height":"400px"}'>
				<img :style='{"width":"100%","objectFit":"cover","float":"left","height":"100%"}' v-if="preHttp(meishixinxiList[4].fengmian)" :src="meishixinxiList[4].fengmian.split(',')[0]" alt="" />
				<img :style='{"width":"100%","objectFit":"cover","float":"left","height":"100%"}' v-else :src="baseUrl + (meishixinxiList[4].fengmian?meishixinxiList[4].fengmian.split(',')[0]:'')" alt="" />
				<div class="list-4-item-title line1" :style='{"color":"#fff","left":"0","textAlign":"center","bottom":"0","background":"rgba(0,0,0,.3)","width":"100%","lineHeight":"44px","fontSize":"18px","position":"absolute"}'>
                    <div>{{meishixinxiList[4].caipinmingcheng}}</div>
                    <div>美食分类:{{meishixinxiList[4].meishifenlei}}</div>
                </div>
			</div>
		</div>
	</div>
	
	<div @click="moreBtn('meishixinxi')" :style='{"border":"2px dashed #71bf03","margin":"0px auto 40px","top":"0","borderRadius":"30px","textAlign":"center","background":"none","display":"inline-block","width":"100px","lineHeight":"40px","position":"absolute","right":"7%"}'>
  ...
  export default {
    ...
    methods: {
      ...
      getSystemIntroduction() {
		...
		getList() {
          let autoSortUrl = "";
          autoSortUrl = "meishixinxi/autoSort";
          if(localStorage.getItem('Token')) {
			...
			this.$http.get(autoSortUrl, {params: {
				...
				if (res.data.code == 0) {
					this.meishixinxiRecommend = res.data.data.list;
			...
			this.$http.get('meishixinxi/list', {params: {
				page: 1,
				limit: 4,
			}}).then(res => {
				if (res.data.code == 0) {
					this.meishixinxiList = res.data.data.list;
